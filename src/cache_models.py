...
import torch
from diffusers import StableDiffusionXLPipeline,ControlNetModel,StableDiffusionXLImg2ImgPipeline, AutoencoderKL
...
def get_diffusion_pipelines():
    ...
    controlnet = fetch_pretrained_model(ControlNetModel,"diffusers/controlnet-canny-sdxl-1.0",**common_args)
    ...
    return controlnet, pipe, refiner, vae
